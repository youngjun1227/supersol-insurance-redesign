...
| 딤(오버레이) | 검정 50% | **`#101828` ≈55%** (흰 위 `#6D7077`, 연회색 위 `#717B8A` → 남색 계열) | text/primary 55% |
| 화면 제목 | 24 ✅ | 24 (01 "금융" · 02 "모든상품" · 07 "빠르고 간편하게" · 1/5 "치료받은 분" 24~26) | h1 24 — **display 28은 06 상품명(실측 ~30)에만** |
